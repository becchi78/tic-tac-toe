...
|---|---|---|---|---|---|
| T-001 | `app/` に Vite + React + TS を scaffold（Vitest / ESLint / Prettier / base 設定） | todo | - | feature/T-001-scaffold-vite-react | |
...
- 進行中: なし（ドキュメント・チケット整備完了、T-001 ディスパッチ待ち）
- ブロッカー: なし
- 次にやること: T-001 を `antigravity-dispatcher` へディスパッチ
